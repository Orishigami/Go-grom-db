...
import (
	...
	db "github.com/orishigami/go-grom-db/DB"

	// นำเข้า db
	"github.com/Orishigami/Go-grom-db/models" // นำเข้า models
)
